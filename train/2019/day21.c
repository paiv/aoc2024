// gcc -O2 -Wall day21.c -o day21 && ./day21 < day21.in
#include <errno.h>
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
static word
springboard(struct ivm_image* program, const char* springscript) {
    static word code[0x1000];
    ...
    FILE* fin = fmemopen((char*) springscript, strlen(springscript), "r");
    if (fin == NULL) { abort(); }
    word chr = 0;
    for (;;) {
